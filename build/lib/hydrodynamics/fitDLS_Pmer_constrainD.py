...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan  7 13:40:56 2020
...
def main():
    ...
    fit_params.add('dCp6', value=-9657.45155)
    
    fit_params.add('dH12_0', value=368795.882)
    fit_params.add('K12_0', value=254145.816)
    fit_params.add('dCp12', value=6668.40535)
    
    fit_params.add('dH24_0', value=2.8729e-9)
    fit_params.add('K24_0', value=1560.57426)
    fit_params.add('dCp24', value=3055.97044)
    
#    fit_params.add('dH24_0', value=0,vary=False)
#    fit_params.add('K24_0', value=0,vary=False)
#    fit_params.add('dCp24', value=0,vary=False)
    
    fit_params.add('dH48_0', value=127599.166)
    fit_params.add('K48_0', value=4009528.17)
    fit_params.add('dCp48', value=-1919.42665)
    
    #fit_params.add('dH48_0', value=0,vary=False)
    #fit_params.add('K48_0', value=0,vary=False)
    #fit_params.add('dCp48', value=0,vary=False)
    
    fit_params.add('dH72_0', value=24366451.5)
    fit_params.add('K72_0', value=646819.868)
    fit_params.add('dCp72', value=30899.3577)
    
    #fit_params.add('dH72_0', value=0,vary=False)
    #fit_params.add('K72_0', value=0,vary=False)
    #fit_params.add('dCp72', value=0,vary=False)
    
    fit_params.add('dH96_0', value=9288199.80)
    fit_params.add('K96_0', value=777646.577)
    fit_params.add('dCp96', value=-21268.8644)
    ...
    fit_params.add('Rh_3', value=5.2654e-9)
    fit_params.add('n',value=-0.18302891)
    #fit_params.add('k_c', value=-52.56)
    fit_params.add('k_c',value=-188.978808)
