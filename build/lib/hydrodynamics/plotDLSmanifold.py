...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  4 17:36:47 2019
...
def plot_fit(DLSdata_groupedbyTemp, DLSdata_groupedbyConc, sample, date):
    ...
    DT_ax.set_ylabel('$\it{D_{z}}$ $cm^{2}$ $s^{-1}$')
    #DT_ax.set_ylim([0.9e-7,8.7e-7])
...
def main():
    ...
    for sample in params['Samples'].keys():
        ...
        #SampleData = SampleData[(SampleData['Concentration'] < 220) & (SampleData['Concentration'] > 7)]
        #SampleData = SampleData[(SampleData['Concentration'] > 7)]
