...
with open(f"{deletion_parameters['csv_name']}",'w') as csv_file:
    ...
    for deletion in deletion_parameters['deletions']:
        ...
        try:
            ...
            print('\nYOUR 5'' SEQUENCE IS PROBABLY TOO SHORT, CHECK IT!\n')
        ...
        try:
            ...
            print('\nYOUR 3'' SEQUENCE IS PROBABLY TOO SHORT, CHECK IT!\n')
        ...
        csv_file.write(f"{deletion}_F,{sense_primer}\n")
        csv_file.write(f"{deletion}_R,{anti_sense_primer}\n")
